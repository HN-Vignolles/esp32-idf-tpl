...
# source: ESP-IDF, components/nvs_flash/project_include.cmake
#
# Create a NVS image of the specified CSV on the host during build and
# optionally have the created image flashed using `idf.py flash` setting FLASH_IN_PROJECT
#
# Call this from main/CMakeLists.txt like this:
#   `nvs_create_partition_image(nvs ../nvs-1.csv FLASH_IN_PROJECT)`
function(nvs_create_partition_image partition csv)
    ...
    if("${size}" AND "${offset}")
        ...
        # (CMakeLists.txt file) that specifies any output of the custom command as a source file is given a rule
        # to generate the file using the command at build time. (CMake documentation)
        add_custom_command(
            OUTPUT ${image_file}
